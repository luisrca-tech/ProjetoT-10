...
export interface FormSelectInputProps {
  ...
  rowCount: number;
  setRanges: React.Dispatch<React.SetStateAction<{ [key: string]: SelectableRange }>>;
...
export interface CommonProps extends FormSelectInputProps {
  ...
  setRowsAndSelectedValues: React.Dispatch<React.SetStateAction<RowsAndSelectedValueProps>>;
}
